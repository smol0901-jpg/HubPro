...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Excel Export
  exportBotsExcel: () => ipcRenderer.invoke('excel:exportBots'),
  exportGroupsExcel: () => ipcRenderer.invoke('excel:exportGroups'),
  exportMessagesExcel: (groupId) => ipcRenderer.invoke('excel:exportMessages', groupId),
  exportSchedulesExcel: () => ipcRenderer.invoke('excel:exportSchedules'),
  exportUsersExcel: () => ipcRenderer.invoke('excel:exportUsers'),
  exportAllExcel: () => ipcRenderer.invoke('excel:exportAll'),
